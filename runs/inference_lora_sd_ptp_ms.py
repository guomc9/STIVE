...
from stive.pipelines.pipeline_ptp_ttv import PtpTextToVideoSDMSPipeline
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    validation_pipeline = PtpTextToVideoSDMSPipeline(vae=vae, text_encoder=text_encoder, tokenizer=tokenizer, unet=lora_unet, scheduler=scheduler)
